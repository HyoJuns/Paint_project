...
public:
    ...
    void setupUi(QMainWindow *Main_Form_Page)
    {
        ...
        btn_list_close->setGeometry(QRect(660, 340, 111, 31));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/resource/image/image/trash_png.ico"), QSize(), QIcon::Normal, QIcon::Off);
        btn_list_close->setIcon(icon9);
...
#endif // QT_CONFIG(shortcut)
        action->setText(QCoreApplication::translate("Main_Form_Page", "\354\203\244\355\224\204\353\213\235", nullptr));
#if QT_CONFIG(shortcut)
        action->setShortcut(QCoreApplication::translate("Main_Form_Page", "Shift+H", nullptr));
#endif // QT_CONFIG(shortcut)
